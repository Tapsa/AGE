...
//	General user interface
	...
	wxGridSizer * General_DataTopRow;
	...
	wxBoxSizer * General_Holder_BorderEnabled1;
	wxStaticText * General_Text_BorderEnabled;
	TextCtrl_Short * General_BorderEnabled;
	CheckBox_Short * General_CheckBox_BorderEnabled;
	...
	wxGridSizer * General_Grid_BorderColors;
