...
//	General user interface
	...
	wxBoxSizer *Borders_BorderEnabled_Holder;
	wxBoxSizer *Borders_BorderEnabled1_Holder;
	wxStaticText *Borders_BorderEnabled_Text;
	TextCtrl_Short *Borders_BorderEnabled;
	CheckBox_2State *Borders_BorderEnabled_CheckBox;
	wxBoxSizer *Borders_BorderName_Holder[2];
	wxStaticText *Borders_BorderName_Text[2];
	TextCtrl_String *Borders_BorderName[2];
	wxBoxSizer *Borders_BorderRessourceID_Holder;
	wxStaticText *Borders_BorderRessourceID_Text;
	TextCtrl_Long *Borders_BorderRessourceID;
	wxBoxSizer *Borders_BorderUnknown3_Holder;
	wxStaticText *Borders_BorderUnknown3_Text;
	TextCtrl_Float *Borders_BorderUnknown3;
	wxBoxSizer *Borders_BorderUnknown4_Holder;
	wxStaticText *Borders_BorderUnknown4_Text;
	TextCtrl_Long *Borders_BorderUnknown4;
	wxBoxSizer *Borders_BorderColors_Holder;
	wxGridSizer *Borders_BorderColors_Grid;
	wxStaticText *Borders_BorderColors_Text;
	array<TextCtrl_UByte*, 3> Borders_BorderColors;
	wxBoxSizer *Borders_BorderUnknown5_Holder;
	wxGridSizer *Borders_BorderUnknown5_Grid;
	wxStaticText *Borders_BorderUnknown5_Text;
	array<TextCtrl_Byte*, 5> Borders_BorderUnknown5;
	wxBoxSizer *Borders_BorderUnknown6_Holder;
	wxStaticText *Borders_BorderUnknown6_Text;
	TextCtrl_Float *Borders_BorderUnknown6;
	wxBoxSizer *Borders_BorderFrameID_Holder;
	wxStaticText *Borders_BorderFrameID_Text;
	TextCtrl_Short *Borders_BorderFrameID;
	wxBoxSizer *Borders_BorderFlag1_Holder;
	wxStaticText *Borders_BorderFlag1_Text;
	TextCtrl_Short *Borders_BorderFlag1;
	wxBoxSizer *Borders_BorderFlag2_Holder;
	wxStaticText *Borders_BorderFlag2_Text;
	TextCtrl_Short *Borders_BorderFlag2;
	wxBoxSizer *Borders_BorderFrameCount_Holder;
	wxStaticText *Borders_BorderFrameCount_Text;
	TextCtrl_Short *Borders_BorderFrameCount;
	wxBoxSizer *Borders_BorderUnknown8_Holder;
	wxStaticText *Borders_BorderUnknown8_Text;
	TextCtrl_Short *Borders_BorderUnknown8;
	wxBoxSizer *Borders_BorderTerrain_Holder;
	wxStaticText *Borders_BorderTerrain_Text;
	TextCtrl_Short *Borders_BorderTerrain;
	ComboBox_Plus1 *Borders_BorderTerrain_ComboBox;
	wxBoxSizer *Borders_BorderUnknown1_Holder;
	wxStaticText *Borders_BorderUnknown1_Text;
...
//	wxCheckBox *Terrains_Terrains_UseAnd;
	...
	wxBoxSizer *Terrains_Unknown2_Holder;
	wxStaticText *Terrains_Unknown2_Text;
	...
	wxBoxSizer *Terrains_Unknown6_Holder;
	wxStaticText *Terrains_Unknown6_Text;
	...
	wxBoxSizer *Terrains_SUnknown1_Holder;
	wxGridSizer *Terrains_SUnknown1_Grid;
	wxStaticText *Terrains_SUnknown1_Text;
