...
void AGE_Frame::CreateTerrainControls()
{
	...
	Terrains_UsedCount = new TextCtrl_UShort(AGEwindow, Tab_Terrains);
	...
	Terrains_Enabled = new TextCtrl_Byte(AGEwindow, Terrains_Scroller, true);
	...
	Terrains_Random = new TextCtrl_Byte(AGEwindow, Terrains_Scroller, true);
	...
	Terrains_Name = new TextCtrl_String(AGEwindow, Terrains_Scroller);
	...
	Terrains_Name2 = new TextCtrl_String(AGEwindow, Terrains_Scroller);
	...
	Terrains_SLP = new TextCtrl_Long(AGEwindow, Terrains_Scroller);
	...
	Terrains_SoundID = new TextCtrl_Long(AGEwindow, Terrains_Scroller);
	...
	Terrains_BlendPriority = new TextCtrl_Long(AGEwindow, Terrains_Scroller);
	...
	Terrains_BlendType = new TextCtrl_Long(AGEwindow, Terrains_Scroller);
	...
	for(short loop = 0; loop < 3; ++loop)
	Terrains_Colors[loop] = new TextCtrl_UByte(AGEwindow, Terrains_Scroller);
	...
	for(short loop = 0; loop < Terrains_CliffColors.size(); ++loop)
	Terrains_CliffColors[loop] = new TextCtrl_UByte(AGEwindow, Terrains_Scroller);
	...
	Terrains_PassableTerrain = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
	...
	Terrains_ImpassableTerrain = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
	...
	Terrains_TerrainReplacementID = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_TerrainDimensions[0] = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	Terrains_TerrainDimensions[1] = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_Unknown3 = new TextCtrl_Long(AGEwindow, Terrains_Scroller);
	...
	Terrains_Unknown1 = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_Border = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_UsedTerrainUnits = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	{
		Terrains_TerrainUnitID[loop] = new TextCtrl_Short(AGEwindow, Terrains_Scroller, true);
		...
		Terrains_TerrainUnitDensity[loop] = new TextCtrl_Short(AGEwindow, Terrains_Scroller, true);
		Terrains_TerrainUnitPriority[loop] = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
	...
	{
		Terrains_ElevationGraphics[loop] = new TextCtrl_Short(AGEwindow, Terrains_Scroller, 2);
	}
	...
	Terrains_IsAnimated = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
	...
	Terrains_AnimationFrames = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_PauseFames = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_Interval = new TextCtrl_Float(AGEwindow, Terrains_Scroller);
	...
	Terrains_PauseBetweenLoops = new TextCtrl_Float(AGEwindow, Terrains_Scroller);
	...
	Terrains_Frame = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_DrawFrame = new TextCtrl_Short(AGEwindow, Terrains_Scroller);
	...
	Terrains_AnimateLast = new TextCtrl_Float(AGEwindow, Terrains_Scroller);
	...
	Terrains_FrameChanged = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
	...
	Terrains_Drawn = new TextCtrl_Byte(AGEwindow, Terrains_Scroller);
