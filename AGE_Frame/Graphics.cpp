...
void AGE_Frame::CreateGraphicsControls()
{
	...
	Graphics_Name = new TextCtrl_String(AGEwindow, Graphics_Scroller);
	...
	Graphics_Name2 = new TextCtrl_String(AGEwindow, Graphics_Scroller);
	...
	Graphics_ID = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	Graphics_SLP = new TextCtrl_Long(AGEwindow, Graphics_Scroller);
	...
	Graphics_FrameType = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_Replay = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_ReplayDelay = new TextCtrl_Float(AGEwindow, Graphics_Scroller);
	...
	Graphics_FrameCount = new TextCtrl_UShort(AGEwindow, Graphics_Scroller);
	...
	Graphics_FrameRate = new TextCtrl_Float(AGEwindow, Graphics_Scroller);
	...
	Graphics_SequenceType = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_MirroringMode = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	for(short loop = 0; loop < 4; ++loop)
	Graphics_Coordinates[loop] = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	Graphics_SoundID = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	Graphics_PlayerColor = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_Rainbow = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_NewSpeed = new TextCtrl_Float(AGEwindow, Graphics_Scroller);
	...
	Graphics_Unknown1 = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_Unknown2 = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	Graphics_Unknown3 = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_GraphicID = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_DirectionX = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_DirectionY = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_Unknown1 = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_Unknown2 = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_Unknown3 = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_Unknown4 = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	GraphicDeltas_Unknown5 = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	...
	Graphics_AngleCount = new TextCtrl_UShort(AGEwindow, Graphics_Scroller);
	...
	Graphics_AttackSoundUsed = new TextCtrl_Byte(AGEwindow, Graphics_Scroller);
	...
	for(short loop = 0; loop < 3; ++loop)
	{
		Graphics_AttackSoundID[loop] = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
		...
		Graphics_AttackSoundDelay[loop] = new TextCtrl_Short(AGEwindow, Graphics_Scroller);
	}
