...
void AGE_Frame::CreatePlayerColorControls()
{
	...
	Colors_Name = new TextCtrl_String(this, AGEwindow, Tab_PlayerColors, 30);
	Colors_ID = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Palette = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Palette->SetToolTip("Starting index of the main color palette\nfrom where 8 colors are dedicated to this player color");
	Colors_ColorL = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_ColorL->SetToolTip("Index of the main color palette");
	Colors_MinimapColor = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_MinimapColor->SetToolTip("Index of the main color palette");
	Colors_Unknown1 = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Unknown2 = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Unknown3 = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Unknown4 = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
	Colors_Unknown5 = new TextCtrl_Long(this, AGEwindow, Tab_PlayerColors);
