...
void AGE_Frame::CreateTerrainBorderControls()
{
	...
	Borders_UsedCount = new TextCtrl_UShort(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Enabled = new TextCtrl_Byte(AGEwindow, Tab_TerrainBorders, true);
	...
	Borders_Random = new TextCtrl_Byte(AGEwindow, Tab_TerrainBorders, true);
	for(short loop = 0; loop < 2; ++loop)
	{
		Borders_Name_Holder[loop] = new wxBoxSizer(wxVERTICAL);
		Borders_Name[loop] = new TextCtrl_String(AGEwindow, Tab_TerrainBorders, 13);
	}
	...
	Borders_SLP = new TextCtrl_Long(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Unknown3 = new TextCtrl_Long(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Sound = new TextCtrl_Long(AGEwindow, Tab_TerrainBorders);
	...
	for(short loop = 0; loop < 3; ++loop)
	Borders_Colors[loop] = new TextCtrl_UByte(AGEwindow, Tab_TerrainBorders);
	...
	Borders_DrawTile = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Terrain = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_BorderStyle = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_FrameID = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Flag1 = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Flag2 = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_IsAnimated = new TextCtrl_Byte(AGEwindow, Tab_TerrainBorders);
	...
	Borders_AnimationFrames = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_PauseFames = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Interval = new TextCtrl_Float(AGEwindow, Tab_TerrainBorders);
	...
	Borders_PauseBetweenLoops = new TextCtrl_Float(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Frame = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_DrawFrame = new TextCtrl_Short(AGEwindow, Tab_TerrainBorders);
	...
	Borders_AnimateLast = new TextCtrl_Float(AGEwindow, Tab_TerrainBorders);
	...
	Borders_FrameChanged = new TextCtrl_Byte(AGEwindow, Tab_TerrainBorders);
	...
	Borders_Drawn = new TextCtrl_Byte(AGEwindow, Tab_TerrainBorders);
