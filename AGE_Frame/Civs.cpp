...
void AGE_Frame::CreateCivControls()
{
	...
	Civs_Name[0] = new TextCtrl_String(this, AGEwindow, Tab_Civs, 20);
	...
	Civs_Name[1] = new TextCtrl_String(this, AGEwindow, Tab_Civs, 20);
	...
	Civs_GraphicSet = new TextCtrl_Byte(this, AGEwindow, Tab_Civs);
	...
	Civs_One = new TextCtrl_Byte(this, AGEwindow, Tab_Civs);
	...
	Civs_TechTree = new TextCtrl_Short(this, AGEwindow, Tab_Civs);
	...
	Civs_TeamBonus = new TextCtrl_Short(this, AGEwindow, Tab_Civs);
	...
	for(short loop = 0; loop < 4; ++loop)
	Civs_SUnknown1[loop] = new TextCtrl_Short(this, AGEwindow, Tab_Civs);
	...
	Civs_ResourceValue = new TextCtrl_Float(this, AGEwindow, Tab_Civs);
