...
void AGE_Frame::CreateGeneralControls()
{
	...
	General_SUnknown2 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_SUnknown3 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_SUnknown4 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_SUnknown5 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_SUnknown7 = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	...
	General_SUnknown8 = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	...
	General_MapPointer = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_Unknown1 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_MapWidth = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_MapHeight = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_WorldWidth = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_WorldHeight = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	General_Unknown2 = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	UnknownPointer1 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	MapMinX = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MapMinY = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MapMaxX = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MapMaxY = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MapMaxXplus1 = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MapMaxYplus1 = new TextCtrl_Float(this, AGEwindow, General_Scroller);
	...
	MaxTerrain = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	TileWidth = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	TileHeight = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	TileHalfHeight = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	TileHalfWidth = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	ElevHeight = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	CurRow = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	CurCol = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	BlockBegRow = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	BlockEndRow = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	BlockBegCol = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	BlockEndCol = new TextCtrl_Short(this, AGEwindow, General_Scroller);
	...
	UnknownPointer2 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	UnknownPointer3 = new TextCtrl_Long(this, AGEwindow, General_Scroller);
	...
	AnyFrameChange = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	...
	MapVisibleFlag = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	...
	FogFlag = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	...
	General_TileSizes[loop] = new TextCtrl_Short(this, AGEwindow, General_Scroller, 2);
	for(short loop = 0; loop < General_SomeBytes.size(); ++loop)
	General_SomeBytes[loop] = new TextCtrl_Byte(this, AGEwindow, General_Scroller);
	for(short loop = 0; loop < General_Something.size(); ++loop)
	General_Something[loop] = new TextCtrl_Long(this, AGEwindow, General_Scroller);
...
void AGE_Frame::CreateUnknownControls()
{
	...
	Unknown_UnknownPointer = new TextCtrl_Long(this, AGEwindow, Tab_Unknown);
	...
	Unknowns_List = new wxListBox(Tab_Unknown, wxID_ANY, wxDefaultPosition, wxSize(200, 220), 0, NULL, wxLB_EXTENDED);
	...
	Unknowns_UnknownLevel = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	Unknowns_Unknown1_Grid = new wxGridSizer(5, 5, 5);
	for(short loop = 0; loop < Unknowns_Unknown1.size(); ++loop)
	{
		Unknowns_Unknown1_Holder[loop] = new wxBoxSizer(wxVERTICAL);
		Unknowns_Unknown1[loop] = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	}
	...
	Unknowns_Pointer1 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_List = new wxListBox(Unknown_Scroller, wxID_ANY, wxDefaultPosition, wxSize(140, 100), 0, NULL, wxLB_EXTENDED);
	...
	RMSBaseZones_Unknown1 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_BaseTerrain = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_SpacingBetweenPlayers = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_Unknown4 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	for(short loop = 0; loop < RMSBaseZones_Unknown5.size(); ++loop)
	RMSBaseZones_Unknown5[loop] = new TextCtrl_Byte(this, AGEwindow, Unknown_Scroller, 3);
	...
	RMSBaseZones_Unknown6 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_Unknown7 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	for(short loop = 0; loop < RMSBaseZones_Unknown8.size(); ++loop)
	RMSBaseZones_Unknown8[loop] = new TextCtrl_Byte(this, AGEwindow, Unknown_Scroller, 3);
	...
	RMSBaseZones_StartAreaRadius = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_Unknown10 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSBaseZones_Unknown11 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	Unknowns_Pointer2 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSTerrain_List = new wxListBox(Unknown_Scroller, wxID_ANY, wxDefaultPosition, wxSize(140, 100), 0, NULL, wxLB_EXTENDED);
	...
	for(short loop = 0; loop < RMSTerrain_Unknown1.size(); ++loop)
	{
		...
		RMSTerrain_Unknown1[loop] = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	}
	...
	Unknowns_Pointer3 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_List = new wxListBox(Unknown_Scroller, wxID_ANY, wxDefaultPosition, wxSize(140, 250), 0, NULL, wxLB_EXTENDED);
	...
	RMSUnit_Unit = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_HostTerrain = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	for(short loop = 0; loop < RMSUnit_Unknown3.size(); ++loop)
	RMSUnit_Unknown3[loop] = new TextCtrl_Byte(this, AGEwindow, Unknown_Scroller, 3);
	...
	RMSUnit_ObjectsPerPlayer = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_Unknown5 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_GroupsPerPlayer = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_Unknown7 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_OwnAtStart = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_SetPlaceForAllPlayers = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_MinDistanceToPlayers = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnit_MaxDistanceToPlayers = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	Unknowns_Pointer4 = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	...
	RMSUnknown_List = new wxListBox(Unknown_Scroller, wxID_ANY, wxDefaultPosition, wxSize(140, 100), 0, NULL, wxLB_EXTENDED);
	...
	for(short loop = 0; loop < RMSUnknown_Unknown1.size(); ++loop)
	{
		...
		RMSUnknown_Unknown1[loop] = new TextCtrl_Long(this, AGEwindow, Unknown_Scroller);
	}
	...
	Connect(Unknowns_List->GetId(), wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler(AGE_Frame::OnRandomMapSelect));
