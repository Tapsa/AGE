...
void AGE_Frame::CreateTerrainRestrictionControls()
{
	...
	TerRestrict_Accessible = new TextCtrl_Float(AGEwindow, Tab_TerrainRestrictions, true);
	...
	TerRestrict_Unknown1 = new TextCtrl_Long(AGEwindow, Tab_TerrainRestrictions);
	...
	TerRestrict_Graphics[0] = new TextCtrl_Long(AGEwindow, Tab_TerrainRestrictions);
	...
	TerRestrict_Graphics[1] = new TextCtrl_Long(AGEwindow, Tab_TerrainRestrictions);
	...
	TerRestrict_Amount = new TextCtrl_Float(AGEwindow, Tab_TerrainRestrictions);
