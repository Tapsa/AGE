...
void AGE_Frame::OnUnitsExtract(wxCommandEvent& Event)
{
	...
	for(short loop = 0;loop < GenieFile->Civs.size();loop++)
	{
		...
		ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey1", GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[0]);
		ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey2", GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[1]);
		ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey3", GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[2]);
		ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey4", GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[3]);
...
void AGE_Frame::OnUnitsImport(wxCommandEvent& Event)
{
	...
	for(short loop = 0;loop < GenieFile->Civs.size();loop++)
	{
		...
		GenieFile->Civs[loop].Units[UnitIDs[0]].LanguageDllHelp = (uint16_t)Number;
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey1", &Number, 0);
		GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[0] = (int16_t)Number;
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey2", &Number, 0);
		GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[1] = (int16_t)Number;
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey3", &Number, 0);
		GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[2] = (int16_t)Number;
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey4", &Number, 0);
		GenieFile->Civs[loop].Units[UnitIDs[0]].HotKey[3] = (int16_t)Number;
