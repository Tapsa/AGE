...
//	Type 10+
		...
		for(short loop = 0;loop < 2;loop++)
		{
			Units_BlastType[loop]->ChangeValue(lexical_cast<string>((short)UnitPointer->Unknown2[loop]));
			Units_BlastType[loop]->Container = &UnitPointer->Unknown2[loop];
		}
...
//	Type 40+
		...
		switch(UnitType)
		{
			...
			Units_AnimalMode->ChangeValue(lexical_cast<string>((short)UnitPointer->Bird.Unknown19));
			Units_AnimalMode->Container = &UnitPointer->Bird.Unknown19;
			break;
			default:
...
//	Type 60+
		...
		switch(UnitType)
		{
			...
			Units_TowerMode->ChangeValue(lexical_cast<string>(UnitPointer->Projectile.Unknown22));
			Units_TowerMode->Container = &UnitPointer->Projectile.Unknown22;
...
//	Units_Holder_AttributesSelection2 = new wxBoxSizer(wxHORIZONTAL);
	Units_Grid_Attributes2 = new wxGridSizer(4, 5, 5);
	...
	Units_Grid_AttributesTrain2 = new wxGridSizer(4, 5, 5);
...
//	Type 10+
	...
	Units_Grid_BlastType = new wxGridSizer(2, 0, 0);
...
//	Type 70+
	...
	Units_Holder_AttackMissileDuplicationUnknown = new wxBoxSizer(wxVERTICAL);
	Units_Grid_AttackMissileDuplicationUnknown = new wxGridSizer(4, 5, 5);
...
//	Type 10+
	...
	Units_Text_BlastType = new wxStaticText(Units_Scroller, wxID_ANY, " Blast Type", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
...
//	Type 40+
	...
	Units_Text_AnimalMode = new wxStaticText(Units_Scroller, wxID_ANY, "Animal Mode ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
...
//	Type 60+
	...
	Units_Text_TowerMode = new wxStaticText(Units_Scroller, wxID_ANY, " Tower Mode", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
	...
	Units_Text_BlastLevel = new wxStaticText(Units_Scroller, wxID_ANY, " Blast Level", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
...
//	Type 60 only
	...
	Units_Text_ProjectileArc = new wxStaticText(Units_Scroller, wxID_ANY, " Projectile Arc ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
...
//	Type 70+
	...
	Units_Text_AttackMissileDuplicationAmount1 = new wxStaticText(Units_Scroller, wxID_ANY, " Attack Missile Dupl. Amount 1 ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
	Units_Text_AttackMissileDuplicationAmount2 = new wxStaticText(Units_Scroller, wxID_ANY, " Attack Missile Dupl. Amount 2 ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
	Units_Text_AttackMissileDuplicationUnknown = new wxStaticText(Units_Scroller, wxID_ANY, " Attack Missile Dupl. Unknown ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
	...
	Units_Text_AttackMissileDuplicationGraphic = new wxStaticText(Units_Scroller, wxID_ANY, " Attack Missile Dupl. Graphic ", wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT | wxST_NO_AUTORESIZE);
...
//	Type 10+
	...
	Units_Holder_EditorRadius->Add(-1, 2);
	Units_Holder_BuildingMode->Add(Units_Text_BuildingMode, 0, wxEXPAND);
	Units_Holder_BuildingMode->Add(-1, 2);
	...
	Units_Holder_CommandAttribute->Add(-1, 2);
	...
	Units_Holder_AttributesHotKey->Add(-1, 2);
	...
	Units_Holder_HPBarHeight2->Add(-1, 2);
...
//	Type 40+
	...
	Units_Holder_AttributesDropSite->Add(-1, 2);
	...
	Units_Holder_AnimalMode->Add(Units_Text_AnimalMode, 0, wxEXPAND);
...
//	Type 60+
	...
	Units_Holder_TowerMode->Add(Units_Text_TowerMode, 0, wxEXPAND);
	...
	Units_Holder_BlastLevel->Add(-1, 2);
...
//	Type 70+
	...
	Units_Holder_AttackMissileDuplicationUnknown->Add(-1, 2);
...
//	Type 10+
	...
	Units_Holder_GarrisonCapacity->AddStretchSpacer(1);
	for(short loop = 0;loop < 2;loop++)
	...
	for(short loop = 0;loop < 2;loop++)
	Units_Grid_BlastType->Add(Units_BlastType[loop], 1, wxEXPAND);
	Units_Holder_BlastType->Add(Units_Grid_BlastType, 0, wxEXPAND);
	...
	Units_Holder_CommandAttribute->AddStretchSpacer(1);
	...
	Units_Holder_SelectionRadius->Add(-1, 2);
...
//	Type 30+
	...
	Units_Holder_TrackingUnit->Add(-1, 2);
	...
	Units_Holder_TrackingUnitDensity->Add(-1, 2);
	Units_Holder_TrackingUnitDensity->Add(Units_TrackingUnitDensity, 1, wxEXPAND);
	Units_Holder_TrackingUnitDensity->AddStretchSpacer(1);
	Units_Holder_Unknown12->Add(Units_Unknown12, 1, wxEXPAND);
	for(short loop = 0;loop < 17;loop++)
	Units_Grid_Unknown16->Add(Units_Unknown16[loop], 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Holder_Unknown16->Add(-1, 2);
...
//	Type 60+
	...
	Units_Holder_Unknown20->Add(-1, 2);
	...
	Units_Holder_TowerMode->AddStretchSpacer(1);
	...
	Units_Holder_GarrisonRecoveryRate->AddStretchSpacer(1);
...
//	Type 60 only
	...
	Units_Holder_ProjectileArc->Add(-1, 2);
...
//	Type 70+
	...
	Units_Holder_ButtonID->Add(-1, 2);
	Units_Holder_ButtonID->Add(Units_ButtonID, 1, wxEXPAND);
	Units_Holder_ButtonID->AddStretchSpacer(1);
	...
	for(short loop = 0;loop < 3;loop++)
	Units_Grid_AttackMissileDuplicationUnknown->Add(Units_AttackMissileDuplicationUnknown[loop], 1, wxEXPAND);
	Units_Holder_AttackMissileDuplicationUnknown->Add(Units_Grid_AttackMissileDuplicationUnknown, 1, wxEXPAND);
...
//	Type 80
	...
	Units_Holder_GarrisonHealRate->AddStretchSpacer(1);
	...
	Units_Holder_GarrisonType->Add(-1, 2);
	...
	Units_Grid_StatsAreaGarrison->Add(Units_Holder_GarrisonType, 2, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Grid_StatsAreaGarrison->Add(Units_Holder_GarrisonHealRate, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Grid_StatsAreaGarrison->Add(Units_Holder_GarrisonRecoveryRate, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
...
//	Units_Holder_StatsArea->Add(5, 5);
	...
	Units_Holder_ProjectileUnitID->Add(-1, 2);
	...
	Units_Holder_AttackMissileDuplicationUnit->Add(-1, 2);
	...
	Units_Holder_AttackMissileDuplicationGraphic->Add(-1, 2);
	...
	Units_Grid_ProjectilesArea3->Add(Units_Holder_AttackMissileDuplicationAmount2, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	...
	Units_Grid_Attributes1->Add(Units_Holder_BuildingMode, 1, wxEXPAND);
	Units_Grid_Attributes1->Add(Units_Holder_PlacementMode, 1, wxEXPAND);
	Units_Grid_Attributes1->Add(Units_Holder_TowerMode, 1, wxEXPAND);
	...
	Units_Grid_AttributesSelection1->Add(Units_Holder_SelectionShapeType, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Grid_AttributesSelection1->Add(Units_Holder_SelectionEffect, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Grid_AttributesSelection1->Add(Units_Holder_EditorSelectionColour, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	...
	Units_Grid_Attributes2->Add(Units_Holder_Unknown7, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	Units_Grid_Attributes2->Add(Units_Holder_Unitline, 1, wxEXPAND | wxRESERVE_SPACE_EVEN_IF_HIDDEN);
	...
	Units_Holder_Attributes->Add(-1, 5);
	Units_Holder_Attributes->Add(Units_Grid_Attributes2, 0, wxEXPAND);
	Units_Holder_Attributes->Add(-1, 5);
	...
	Units_Holder_Attributes->Add(-1, 5);
	Units_Holder_Attributes->Add(Units_Grid_AttributesTrain2, 0, wxEXPAND);
	Units_Holder_Attributes->Add(-1, 5);
	...
	Units_Holder_Type10plusUnknowns1->Add(Units_Holder_BlastType, 0, wxEXPAND);
...
//	Listing and Auto Copy
	...
	for(short loop = 0;loop < 2;loop++)
	{
		Units_BlastType[loop]->Connect(Units_BlastType[loop]->GetId(), wxEVT_KILL_FOCUS, wxFocusEventHandler(AGE_Frame::OnKillFocus_AutoCopy_Byte), NULL, this);
	...
	Units_AnimalMode->Connect(Units_AnimalMode->GetId(), wxEVT_KILL_FOCUS, wxFocusEventHandler(AGE_Frame::OnKillFocus_AutoCopy_Byte), NULL, this);
	...
	Units_TowerMode->Connect(Units_TowerMode->GetId(), wxEVT_KILL_FOCUS, wxFocusEventHandler(AGE_Frame::OnKillFocus_AutoCopy_Short), NULL, this);
