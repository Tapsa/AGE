...
void AGE_Frame::OnUnitsExtract(wxCommandEvent& Event)
{
	...
	for(short loop = 0;loop < GenieFile->Civs.size();loop++)
	{
		...
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 40)
		{
			...
			if(GameVersion < 2)
			{
			CountHolder = GenieFile->Civs[loop].Units[UnitID].Bird.Commands.size();
			ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/CommandCount", CountHolder);
			for(short loop2 = 0;loop2 < CountHolder;loop2++)
			{
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"One", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].One);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ID);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown1", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown1);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Type", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Type);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ClassID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ClassID);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"UnitID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].UnitID);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown2", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown2);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ResourceIn", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ResourceIn);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"SubType", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].SubType);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ResourceOut", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ResourceOut);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown3", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown3);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown4", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown4);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ExecutionRadius", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ExecutionRadius);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown5", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown5);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown6", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown6);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown7", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown7);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown8", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown8);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown9", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown9);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown10", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown10);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown11", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown11);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown12", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown12);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown13", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown13);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown14", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown14);
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"XX", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown2);
				for(short loop3 = 0;loop3 < 6;loop3++)
				ExtractUnit->Write("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Graphic"+lexical_cast<string>(loop3), GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Graphics[loop3]);
			}
			}
...
void AGE_Frame::OnUnitsImport(wxCommandEvent& Event)
{
	...
	for(short loop = 0;loop < GenieFile->Civs.size();loop++)
	{
		...
		/*ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/LanguageDllName", GenieFile->Civs[loop].Units[UnitID].LanguageDllName);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/LanguageDllCreation", GenieFile->Civs[loop].Units[UnitID].LanguageDllCreation);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DyingGraphic1", GenieFile->Civs[loop].Units[UnitID].DyingGraphic.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DyingGraphic2", GenieFile->Civs[loop].Units[UnitID].DyingGraphic.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DeathMode", GenieFile->Civs[loop].Units[UnitID].DeathMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HitPoints", GenieFile->Civs[loop].Units[UnitID].HitPoints);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/LineOfSight", GenieFile->Civs[loop].Units[UnitID].LineOfSight);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/GarrisonCapacity", GenieFile->Civs[loop].Units[UnitID].GarrisonCapacity);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SizeRadius1", GenieFile->Civs[loop].Units[UnitID].SizeRadius.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SizeRadius2", GenieFile->Civs[loop].Units[UnitID].SizeRadius.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HPBarHeight1", GenieFile->Civs[loop].Units[UnitID].HPBarHeight1);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DeadUnitID", GenieFile->Civs[loop].Units[UnitID].DeadUnitID);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/PlacementMode", GenieFile->Civs[loop].Units[UnitID].PlacementMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/AirMode", GenieFile->Civs[loop].Units[UnitID].AirMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/IconID", GenieFile->Civs[loop].Units[UnitID].IconID);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HideInEditor", GenieFile->Civs[loop].Units[UnitID].HideInEditor);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown1", GenieFile->Civs[loop].Units[UnitID].Unknown1);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Enabled", GenieFile->Civs[loop].Units[UnitID].Enabled);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/PlacementBypassTerrain1", GenieFile->Civs[loop].Units[UnitID].PlacementBypassTerrain.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/PlacementBypassTerrain2", GenieFile->Civs[loop].Units[UnitID].PlacementBypassTerrain.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/PlacementTerrain1", GenieFile->Civs[loop].Units[UnitID].PlacementTerrain.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/PlacementTerrain2", GenieFile->Civs[loop].Units[UnitID].PlacementTerrain.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/EditorRadius1", GenieFile->Civs[loop].Units[UnitID].EditorRadius.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/EditorRadius2", GenieFile->Civs[loop].Units[UnitID].EditorRadius.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/BuildingMode", GenieFile->Civs[loop].Units[UnitID].BuildingMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/VisibleInFog", GenieFile->Civs[loop].Units[UnitID].VisibleInFog);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/TerrainRestriction", GenieFile->Civs[loop].Units[UnitID].TerrainRestriction);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/FlyMode", GenieFile->Civs[loop].Units[UnitID].FlyMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/ResourceCapacity", GenieFile->Civs[loop].Units[UnitID].ResourceCapacity);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/ResourceDecay", GenieFile->Civs[loop].Units[UnitID].ResourceDecay);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/BlastType", GenieFile->Civs[loop].Units[UnitID].BlastType);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown2", GenieFile->Civs[loop].Units[UnitID].Unknown2);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/InteractionMode", GenieFile->Civs[loop].Units[UnitID].InteractionMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/MinimapMode", GenieFile->Civs[loop].Units[UnitID].MinimapMode);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/CommandAttribute", GenieFile->Civs[loop].Units[UnitID].CommandAttribute);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown3", GenieFile->Civs[loop].Units[UnitID].Unknown3);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown3B", GenieFile->Civs[loop].Units[UnitID].Unknown3B);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/LanguageDllHelp", GenieFile->Civs[loop].Units[UnitID].LanguageDllHelp);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey1", GenieFile->Civs[loop].Units[UnitID].HotKey[0]);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey2", GenieFile->Civs[loop].Units[UnitID].HotKey[1]);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey3", GenieFile->Civs[loop].Units[UnitID].HotKey[2]);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HotKey4", GenieFile->Civs[loop].Units[UnitID].HotKey[3]);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown4", GenieFile->Civs[loop].Units[UnitID].Unknown4);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown5", GenieFile->Civs[loop].Units[UnitID].Unknown5);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unselectable", GenieFile->Civs[loop].Units[UnitID].Unselectable);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown6", GenieFile->Civs[loop].Units[UnitID].Unknown6);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionMask", GenieFile->Civs[loop].Units[UnitID].SelectionMask);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionShape", GenieFile->Civs[loop].Units[UnitID].SelectionShape);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionRadius1", GenieFile->Civs[loop].Units[UnitID].SelectionRadius.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionRadius2", GenieFile->Civs[loop].Units[UnitID].SelectionRadius.second);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/HPBarHeight2", GenieFile->Civs[loop].Units[UnitID].HPBarHeight2);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionSound", GenieFile->Civs[loop].Units[UnitID].SelectionSound);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DyingSound", GenieFile->Civs[loop].Units[UnitID].DyingSound);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/AttackSound", GenieFile->Civs[loop].Units[UnitID].AttackSound);*/
		...
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/NameLength", &Number, 9);
		GenieFile->Civs[loop].Units[UnitID].NameLength = (short)Number;
		/*ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/StandingGraphic1", GenieFile->Civs[loop].Units[UnitID].StandingGraphic.first);
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/TrainSound1", GenieFile->Civs[loop].Units[UnitID].TrainSound.first);
		if(GameVersion != 2)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Attribute", GenieFile->Civs[loop].Units[UnitID].Attribute);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Civilization", GenieFile->Civs[loop].Units[UnitID].Civilization);
		}
		if(GameVersion >= 2)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/StandingGraphic2", GenieFile->Civs[loop].Units[UnitID].StandingGraphic.second);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/TrainSound2", GenieFile->Civs[loop].Units[UnitID].TrainSound.second);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown7", GenieFile->Civs[loop].Units[UnitID].Unknown7);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown8", GenieFile->Civs[loop].Units[UnitID].Unknown8);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionShapeType", GenieFile->Civs[loop].Units[UnitID].SelectionShapeType);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/SelectionEffect", GenieFile->Civs[loop].Units[UnitID].SelectionEffect);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/EditorSelectionColour", GenieFile->Civs[loop].Units[UnitID].EditorSelectionColour);
			if(GameVersion >= 3)
			{
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown9A", GenieFile->Civs[loop].Units[UnitID].Unknown9[0]);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown9B", GenieFile->Civs[loop].Units[UnitID].Unknown9[1]);
				if(GameVersion >= 4)
				{
					ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Name2", GenieFile->Civs[loop].Units[UnitID].Name2);
					ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/NameLength2", GenieFile->Civs[loop].Units[UnitID].NameLength2);
					ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unitline", GenieFile->Civs[loop].Units[UnitID].Unitline);
					ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/MinTechLevel", GenieFile->Civs[loop].Units[UnitID].MinTechLevel);
				}
			}
		}
		else
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Unknown3a", GenieFile->Civs[loop].Units[UnitID].Unknown3a);
		}
		for(short loop2 = 0;loop2 < 3;loop2++)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/ResourceStorage"+lexical_cast<string>(loop2)+"Type", GenieFile->Civs[loop].Units[UnitID].ResourceStorages[loop2].Type);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/ResourceStorage"+lexical_cast<string>(loop2)+"Amount", GenieFile->Civs[loop].Units[UnitID].ResourceStorages[loop2].Amount);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/ResourceStorage"+lexical_cast<string>(loop2)+"Enabled", GenieFile->Civs[loop].Units[UnitID].ResourceStorages[loop2].Enabled);
		}
		ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/DamageGraphicCount", GenieFile->Civs[loop].Units[UnitID].DamageGraphics.size());
		for(short loop2 = 0;loop2 < GenieFile->Civs[loop].Units[UnitID].DamageGraphics.size();loop2++)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Dama"+lexical_cast<string>(loop2)+"GraphicID", GenieFile->Civs[loop].Units[UnitID].DamageGraphics[loop2].GraphicID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Dama"+lexical_cast<string>(loop2)+"DamagePercent", GenieFile->Civs[loop].Units[UnitID].DamageGraphics[loop2].DamagePercent);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Dama"+lexical_cast<string>(loop2)+"Unknown1", GenieFile->Civs[loop].Units[UnitID].DamageGraphics[loop2].Unknown1);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Common/Dama"+lexical_cast<string>(loop2)+"Unknown2", GenieFile->Civs[loop].Units[UnitID].DamageGraphics[loop2].Unknown2);
		}
		if(GenieFile->Civs[loop].Units[UnitID].Type != 90)
		{
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 20)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Flag/Speed", GenieFile->Civs[loop].Units[UnitID].Speed);
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 30)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/WalkingGraphic1", GenieFile->Civs[loop].Units[UnitID].DeadFish.WalkingGraphic.first);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/WalkingGraphic2", GenieFile->Civs[loop].Units[UnitID].DeadFish.WalkingGraphic.second);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/RotationSpeed", GenieFile->Civs[loop].Units[UnitID].DeadFish.RotationSpeed);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/Unknown11", GenieFile->Civs[loop].Units[UnitID].DeadFish.Unknown11);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/TrackingUnit", GenieFile->Civs[loop].Units[UnitID].DeadFish.TrackingUnit);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/TrackingUnitUsed", GenieFile->Civs[loop].Units[UnitID].DeadFish.TrackingUnitUsed);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/TrackingUnitDensity", GenieFile->Civs[loop].Units[UnitID].DeadFish.TrackingUnitDensity);
			if(GameVersion >= 2)
			{
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/Unknown12", GenieFile->Civs[loop].Units[UnitID].DeadFish.Unknown12);
				for(short loop2 = 0;loop2 < 17;loop2++)
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/Unknown16_"+lexical_cast<string>(loop2), GenieFile->Civs[loop].Units[UnitID].DeadFish.Unknown16[loop2]);
			}
			else
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_DeadFish/Unknown16", GenieFile->Civs[loop].Units[UnitID].DeadFish.Unknown16[0]);
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 40)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/SheepConversion", GenieFile->Civs[loop].Units[UnitID].Bird.SheepConversion);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/SearchRadius", GenieFile->Civs[loop].Units[UnitID].Bird.SearchRadius);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/WorkRate", GenieFile->Civs[loop].Units[UnitID].Bird.WorkRate);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/DropSite", GenieFile->Civs[loop].Units[UnitID].Bird.DropSite);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/VillagerMode", GenieFile->Civs[loop].Units[UnitID].Bird.VillagerMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/MoveSound", GenieFile->Civs[loop].Units[UnitID].Bird.MoveSound);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/StopSound", GenieFile->Civs[loop].Units[UnitID].Bird.StopSound);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/AnimalMode", GenieFile->Civs[loop].Units[UnitID].Bird.AnimalMode);
			if(GameVersion < 2)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/CommandCount", GenieFile->Civs[loop].Units[UnitID].Bird.Commands.size());
			for(short loop2 = 0;loop2 < GenieFile->Civs[loop].Units[UnitID].Bird.Commands.size();loop2++)
			{
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"One", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].One);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ID);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown1", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown1);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Type", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Type);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ClassID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ClassID);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"UnitID", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].UnitID);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown2", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown2);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ResourceIn", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ResourceIn);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"SubType", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].SubType);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ResourceOut", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ResourceOut);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown3", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown3);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown4", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown4);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"ExecutionRadius", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].ExecutionRadius);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown5", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown5);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown6", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown6);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown7", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown7);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown8", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown8);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown9", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown9);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown10", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown10);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown11", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown11);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown12", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown12);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown13", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown13);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Unknown14", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown14);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"XX", GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Unknown2);
				for(short loop3 = 0;loop3 < 6;loop3++)
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Bird/Command"+lexical_cast<string>(loop2)+"Graphic"+lexical_cast<string>(loop3), GenieFile->Civs[loop].Units[UnitID].Bird.Commands[loop2].Graphics[loop3]);
			}
			}
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 60)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Unknown20", GenieFile->Civs[loop].Units[UnitID].Projectile.Unknown20);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/AttackCount", GenieFile->Civs[loop].Units[UnitID].Projectile.Attacks.size());
			for(short loop2 = 0;loop2 < GenieFile->Civs[loop].Units[UnitID].Projectile.Attacks.size();loop2++)
			{
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Attack"+lexical_cast<string>(loop2)+"Class", GenieFile->Civs[loop].Units[UnitID].Projectile.Attacks[loop2].Class);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Attack"+lexical_cast<string>(loop2)+"Amount", GenieFile->Civs[loop].Units[UnitID].Projectile.Attacks[loop2].Amount);
			}
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/ArmourCount", GenieFile->Civs[loop].Units[UnitID].Projectile.Armours.size());
			for(short loop2 = 0;loop2 < GenieFile->Civs[loop].Units[UnitID].Projectile.Armours.size();loop2++)
			{
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Armor"+lexical_cast<string>(loop2)+"Class", GenieFile->Civs[loop].Units[UnitID].Projectile.Armours[loop2].Class);
				ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Armor"+lexical_cast<string>(loop2)+"Amount", GenieFile->Civs[loop].Units[UnitID].Projectile.Armours[loop2].Amount);
			}
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Unknown21", GenieFile->Civs[loop].Units[UnitID].Projectile.Unknown21);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/MaxRange", GenieFile->Civs[loop].Units[UnitID].Projectile.MaxRange);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/BlastRadius", GenieFile->Civs[loop].Units[UnitID].Projectile.BlastRadius);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/ProjectileUnitID", GenieFile->Civs[loop].Units[UnitID].Projectile.ProjectileUnitID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/AccuracyPercent", GenieFile->Civs[loop].Units[UnitID].Projectile.AccuracyPercent);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/TowerMode", GenieFile->Civs[loop].Units[UnitID].Projectile.TowerMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Delay", GenieFile->Civs[loop].Units[UnitID].Projectile.Delay);
			for(short loop2 = 0;loop2 < 3;loop2++)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/GraphicDisplacement"+lexical_cast<string>(loop2), GenieFile->Civs[loop].Units[UnitID].Projectile.GraphicDisplacement[loop2]);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Unknown23", GenieFile->Civs[loop].Units[UnitID].Projectile.Unknown23);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/MinRange", GenieFile->Civs[loop].Units[UnitID].Projectile.MinRange);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/AttackGraphic", GenieFile->Civs[loop].Units[UnitID].Projectile.AttackGraphic);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/DisplayedMeleeArmour", GenieFile->Civs[loop].Units[UnitID].Projectile.DisplayedMeleeArmour);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/DisplayedAttack", GenieFile->Civs[loop].Units[UnitID].Projectile.DisplayedAttack);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/DisplayedRange", GenieFile->Civs[loop].Units[UnitID].Projectile.DisplayedRange);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/ReloadTime1", GenieFile->Civs[loop].Units[UnitID].Projectile.ReloadTime1);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/ReloadTime2", GenieFile->Civs[loop].Units[UnitID].Projectile.ReloadTime2);
			if(GameVersion >= 2)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/GarrisonRecoveryRate", GenieFile->Civs[loop].Units[UnitID].Projectile.GarrisonRecoveryRate);
			if(GameVersion >= 3)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Projectile/Unknown20_1", GenieFile->Civs[loop].Units[UnitID].Projectile.Unknown20_1);
			}
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 70)
		{
			for(short loop2 = 0;loop2 < 3;loop2++)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/ResourceCost"+lexical_cast<string>(loop2)+"Type", GenieFile->Civs[loop].Units[UnitID].Creatable.ResourceCosts[loop2].Type);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/ResourceCost"+lexical_cast<string>(loop2)+"Amount", GenieFile->Civs[loop].Units[UnitID].Creatable.ResourceCosts[loop2].Amount);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/ResourceCost"+lexical_cast<string>(loop2)+"Enabled", GenieFile->Civs[loop].Units[UnitID].Creatable.ResourceCosts[loop2].Enabled);
			}
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/TrainTime", GenieFile->Civs[loop].Units[UnitID].Creatable.TrainTime);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/TrainLocationID", GenieFile->Civs[loop].Units[UnitID].Creatable.TrainLocationID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/ButtonID", GenieFile->Civs[loop].Units[UnitID].Creatable.ButtonID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/DisplayedPierceArmour", GenieFile->Civs[loop].Units[UnitID].Creatable.DisplayedPierceArmour);
			if(GameVersion >= 2)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/Unknown26", GenieFile->Civs[loop].Units[UnitID].Creatable.Unknown26);
			for(short loop2 = 0;loop2 < 3;loop2++)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/Unknown27_"+lexical_cast<string>(loop2), GenieFile->Civs[loop].Units[UnitID].Creatable.Unknown27[loop2]);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/Unknown28", GenieFile->Civs[loop].Units[UnitID].Creatable.Unknown28);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/MissileGraphicDelay", GenieFile->Civs[loop].Units[UnitID].Creatable.MissileGraphicDelay);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/HeroMode", GenieFile->Civs[loop].Units[UnitID].Creatable.HeroMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/GarrisonGraphic", GenieFile->Civs[loop].Units[UnitID].Creatable.GarrisonGraphic);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/AttackMissileDuplicationAmount1", GenieFile->Civs[loop].Units[UnitID].Creatable.AttackMissileDuplicationAmount1);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/AttackMissileDuplicationAmount2", GenieFile->Civs[loop].Units[UnitID].Creatable.AttackMissileDuplicationAmount2);
			for(short loop2 = 0;loop2 < 3;loop2++)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/AttackMissileDuplicationSpawning"+lexical_cast<string>(loop2), GenieFile->Civs[loop].Units[UnitID].Creatable.AttackMissileDuplicationSpawning[loop2]);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/AttackMissileDuplicationUnit", GenieFile->Civs[loop].Units[UnitID].Creatable.AttackMissileDuplicationUnit);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/AttackMissileDuplicationGraphic", GenieFile->Civs[loop].Units[UnitID].Creatable.AttackMissileDuplicationGraphic);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Creatable/Unknown29", GenieFile->Civs[loop].Units[UnitID].Creatable.Unknown29);
			}
		if(GenieFile->Civs[loop].Units[UnitID].Type >= 80)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/ConstructionGraphicID", GenieFile->Civs[loop].Units[UnitID].Building.ConstructionGraphicID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/AdjacentMode", GenieFile->Civs[loop].Units[UnitID].Building.AdjacentMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown31", GenieFile->Civs[loop].Units[UnitID].Building.Unknown31);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown31b", GenieFile->Civs[loop].Units[UnitID].Building.Unknown31b);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/StackUnitID", GenieFile->Civs[loop].Units[UnitID].Building.StackUnitID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/TerrainID", GenieFile->Civs[loop].Units[UnitID].Building.TerrainID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown32", GenieFile->Civs[loop].Units[UnitID].Building.Unknown32);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/ResearchID", GenieFile->Civs[loop].Units[UnitID].Building.ResearchID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/ConstructionSound", GenieFile->Civs[loop].Units[UnitID].Building.ConstructionSound);
			if(GameVersion >= 2)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown33", GenieFile->Civs[loop].Units[UnitID].Building.Unknown33);
			for(short loop2 = 0;loop2 < 4;loop2++)
			{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Annex"+lexical_cast<string>(loop2)+"UnitID", GenieFile->Civs[loop].Units[UnitID].Building.Annexes[loop2].UnitID);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Annex"+lexical_cast<string>(loop2)+"Misplacement1", GenieFile->Civs[loop].Units[UnitID].Building.Annexes[loop2].Misplacement.first);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Annex"+lexical_cast<string>(loop2)+"Misplacement2", GenieFile->Civs[loop].Units[UnitID].Building.Annexes[loop2].Misplacement.second);
			}
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/HeadUnit", GenieFile->Civs[loop].Units[UnitID].Building.HeadUnit);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/TransformUnit", GenieFile->Civs[loop].Units[UnitID].Building.TransformUnit);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown34", GenieFile->Civs[loop].Units[UnitID].Building.Unknown34);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/GarrisonType", GenieFile->Civs[loop].Units[UnitID].Building.GarrisonType);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/GarrisonHealRate", GenieFile->Civs[loop].Units[UnitID].Building.GarrisonHealRate);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown35", GenieFile->Civs[loop].Units[UnitID].Building.Unknown35);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown36", GenieFile->Civs[loop].Units[UnitID].Building.Unknown36);
			for(short loop2 = 0;loop2 < 6;loop2++)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/Unknown37_"+lexical_cast<string>(loop2), GenieFile->Civs[loop].Units[UnitID].Building.Unknown37[loop2]);
			if(GameVersion >= 3)
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_Building/SnowGraphicID", GenieFile->Civs[loop].Units[UnitID].Building.SnowGraphicID);
			}
		}}}}}}
		if(GenieFile->Civs[loop].Units[UnitID].Type == 60)
		{
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/StretchMode", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.StretchMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/CompensationMode", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.CompensationMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/DropAnimationMode", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.DropAnimationMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/PenetrationMode", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.PenetrationMode);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/Unknown24", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.Unknown24);
			ExtractUnit->Read("Civ"+lexical_cast<string>(loop)+"_Unit_ProjectileOnly/ProjectileArc", GenieFile->Civs[loop].Units[UnitID].ProjectileOnly.ProjectileArc);
		}}*/
	}
	delete ExtractUnit;
}
